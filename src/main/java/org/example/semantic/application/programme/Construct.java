        ...
        if (model != null) {
            ...
            String sparqlConstruct =
                    "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
                            ...
                            "PREFIX ns: <" + NS + ">\n" +
                            "CONSTRUCT { ?programme rdf:type ns:Programme_de_Bien_Être . " +
                            "               ?programme ns:comprend ?activite . } " +
                            "WHERE { ?programme rdf:type ns:Programme_de_Bien_Être . " +
                            "                ?programme ns:comprend ?activite . " +
                            "                ?activite rdf:type ns:Activité . }"; // Adjust based on specific query requirements
