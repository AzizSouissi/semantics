...
public class SELECT {
    ...
    public static void main(String[] args) {
        ...
        addInstance(inferredModel, "Objectif1", "Gestion_des_Objectifs", "Amélioration des Compétences", "Objectif pour améliorer les compétences personnelles.");
        addInstance(inferredModel, "Objectif2", "Gestion_des_Objectifs", "Santé et Bien-être", "Objectif pour maintenir une bonne santé mentale et physique.");

        // Exécuter des requêtes SPARQL pour récupérer les individus de la classe Gestion_des_Objectifs
        executeQuery(inferredModel, "SELECT ?individu WHERE { ?individu rdf:type <" + NS + "Gestion_des_Objectifs> . }", "individu");
    }
