...
public class ASK {
    ...
    public static void main(String[] args) {
        ...
        String NS = "http://www.semanticweb.org/daghnouj/ontologies/2024/9/untitled-ontology-19#"; // Assurez-vous que le namespace est correct
        String ontologyFile = "data/ontologie.owl"; // Chemin vers votre fichier ontologique
        ...
        try {
            ...
            return; // Quitter si l'ontologie ne peut pas être chargée
        }
