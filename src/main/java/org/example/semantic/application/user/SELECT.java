...
public class SELECT {
    ...
    public static void main(String[] args) {
        ...
        addInstance(inferredModel, "Utilisateur1", "Gestions_des_Utilisateurs", "John Doe", "Utilisateur inscrit pour gestion des objectifs.");
        addInstance(inferredModel, "Utilisateur2", "Gestions_des_Utilisateurs", "Jane Smith", "Utilisateur expérimenté en gestion des projets.");

        // Exécuter des requêtes SPARQL pour récupérer les individus de la classe Gestions_des_Utilisateurs
        executeQuery(inferredModel, "SELECT ?individu WHERE { ?individu rdf:type <" + NS + "Gestions_des_Utilisateurs> . }", "individu");
    }
